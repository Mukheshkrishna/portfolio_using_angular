...
export class ProfileService {
  ...
  educationData: any = [
    {
      'id': '1',
      'from_to_year': '2020 - 2024',
      'education': 'Bachelor\'s Degree',
      'stream': 'Bachelor of Engineering',
      'info': `Vishnu Institute of Technology is GTU Affiliated and ranks 1st in Bhimavaram
...
Maintained above 9.1 spi in every semester of college academic .`,
    ...
    },
    {
      ...
      'institution': 'Sasi Junior of College, TANUKU',
      'info': `The High School was mainly focus on the bases of science, mathematics, and Chemistry
There was also a good base on physics, mathematics and chemistry.
Completed my high school with 97%.`
    },
    {
      'id': '3',
      ...
      'stream': 'Science and Mathematics',
      'institution': 'MONTESSORI SCHOOL,TANUKU',
